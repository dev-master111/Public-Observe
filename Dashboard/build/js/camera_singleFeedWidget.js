var schedule = [{time: new Date().setHours(7,39,0,0),kilo:235,rate:18},
                {time: new Date().setHours(12,17,0,0),kilo:175,rate:16},
                {time: new Date().setHours(16,15,0,0),kilo:295,rate:12},
                {time: new Date().setHours(13,15,0,0),kilo:295,rate:12}
              ];
...
function animateUpdate() {
 ...
 // Slideshow code
  ...
  $("#feeding_params").height($("#video_").height());
  $("#3d").height($("#sensors").height());
});
