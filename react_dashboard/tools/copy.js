...
async function copy({ watch } = {}) {
  ...
  // Included react grid stuff..
  await Promise.all([
    ncp('node_modules/react-grid-layout/css/styles.css', 'build/public/css/react-grid-layout.css'),
    ncp('node_modules/react-resizable/css/styles.css', 'build/public/css/react-resizable.css'),
  ]);
